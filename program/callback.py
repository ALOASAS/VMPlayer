...
💡 **تعرف على جميع أوامر البوت وكيفية عملها من خلال النقر فوق زر "الأوامر"**

🔖 **لمعرفة كيفية استخدام هذا البوت ، الرجاء النقر فوق »زر الدليل الأساسي!**""",
...
1.) ** أولاً ، أضفني إلى مجموعتك. **
 ...
 5.) ** في بعض الأحيان ، يمكن أن تساعدك إعادة تحميل البوت باستخدام /reload تحميل الأمر في إصلاح بعض المشاكل. **
📌 **إذا لم ينضم المستخدم البوت إلى الدردشة المرئية ، فتأكد من تشغيل دردشة الفيديو بالفعل ، أو اكتب /userbotleave ثم اكتب /userbotjoin مرة أخرى..**

💡 **إذا كانت لديك أسئلة متابعة حول هذا البوت ، فيمكنك إخباره من خلال دردشة الدعم الخاصة بي هنا: @{GROUP_SUPPORT}**
...
»/song محمد السالم اعوف الدنيا
 »/ping - سرعة البوت
 »/uptime - إظهار حالة وقت تشغيل البوت
 »/alive - إظهار معلومات البوت على قيد الحياة (في مجموعة)
